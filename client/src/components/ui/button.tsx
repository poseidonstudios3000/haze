...
const buttonVariants = cva(
  ...
  " hover-elevate active-elevate-2 beam-effect transition-all",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          ...
          "border [border-color:var(--button-outline)] shadow-xs active:shadow-none rounded-md text-sm font-medium",
        secondary: "border bg-secondary text-secondary-foreground border border-secondary-border rounded-md text-sm font-medium",
      ...
      size: {
        ...
        lg: "min-h-10 px-8",
        xl: "min-h-14 px-12 py-4 text-xl",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
