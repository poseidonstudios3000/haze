...
const PRIVATE_FAQ: FAQItem[] = [
  ...
  { category: "Booking", question: "How far in advance should I book?", answer: "Typically 1 to 6 months for private events. DJ Miss Haze is already booking into 2028, so enquire early — last-minute and same-day emergency bookings are possible, subject to availability." },
  { category: "Booking", question: "What's the investment to book DJ Miss Haze?", answer: "DJ Miss Haze thinks of it as an investment, not a price. Private event investment begins at $2,200, covering custom DJ and MC services, preparation meetings, vendor collaboration, custom song edits for key moments, and the full audio, microphone and dance-floor lighting setup. Final pricing is confirmed on your first call or Zoom." },
  { category: "Booking", question: "Which payment methods do you accept?", answer: "DJ Miss Haze offers the following payment methods: ACH, Cash, Check, Credit and Debit Card, Cryptocurrencies, Wire, and Zelle." },
...
const OTHER_FAQ: FAQItem[] = [
  ...
  { category: "Booking", question: "How far in advance should I book?", answer: "Typically 1 to 6 months for other event types. DJ Miss Haze is already booking into 2028, so enquire early — last-minute and same-day emergency services are available, subject to availability." },
...
//
// VENUES: the Chicago and Denver copy below name client-confirmed venues. The
// Chicago list is final — nothing further pending. The Denver list was expanded
// with her additional venues (industrial rooms, the Estes Park cluster, and the
// wider Front Range reach).
// TODO(client): Dallas is intentionally market-only — she hasn't supplied any
// DFW venues or planners yet; work real names into the Dallas copy once she does.
...
> = {
  chicago: {
    wedding: {
      ...
      localMarket: {
        ...
        blocks: [
          ...
          { label: "Downtown and River North", text: "bring the classic hotel ballroom and the polished downtown rooms — LUXBAR, Walden, The Carter, Private Dining by Sepia, The Wellsley. Grand, formal, usually on a tight timeline with a hard end time, and rewarding precision: cues that land on the beat, announcements that move three hundred guests without ever feeling rushed." },
          ...
          { label: "The suburbs", text: "— Naperville, Oak Brook, Glenview, Hinsdale, Downers Grove — bring country clubs and private estates like The Drake Oak Brook, Morton Arboretum in Lisle, Cantigny Park in Wheaton and Riverside Receptions in Geneva, often with longer receptions and a wider guest age range: a floor that has to hold grandparents at nine and college friends at midnight. And Chicagoland isn't the edge of the map — I regularly work venues well beyond it, from Heritage Harbor in Ottawa to Pear Tree Estate in Champaign and Allerton Park in Monticello, which is exactly why the 100-mile radius is worth spelling out." },
        ],
        closing: [
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Do you travel to the Chicago suburbs?", answer: "Yes. Naperville, Oak Brook, Glenview, Hinsdale, Downers Grove, Burr Ridge, Lombard, Oak Park and the wider Chicagoland area are all standard territory — I've worked venues like The Drake Oak Brook, Morton Arboretum in Lisle, Cantigny Park in Wheaton and Riverside Receptions in Geneva, and further out to Heritage Harbor in Ottawa, Pear Tree Estate in Champaign and Allerton Park in Monticello. Anywhere within 100 miles of Chicago carries no travel surcharge; destinations beyond that are available with a travel fee, quoted upfront." },
          ...
          { category: "Booking", question: "How far in advance should I book a Chicago wedding date?", answer: "For weddings, 6 to 24 months is typical in Chicago, and September and October Saturdays go earliest. I'm already booking into 2028, so enquire early — off-peak and weekday dates have more availability, and if your date is close it's always worth asking." },
    ...
    hub: {
      ...
      localMarket: {
        ...
        blocks: [
          { label: "Downtown and River North", text: "hold the hotel ballrooms and polished downtown rooms — LUXBAR, Walden, The Carter, Private Dining by Sepia — and the formal end of the calendar: weddings with three hundred guests, corporate galas, milestone celebrations. Tight timelines, firm end times, and rooms that reward precision." },
          ...
          { label: "The suburbs", text: "— Naperville, Oak Brook, Glenview, Hinsdale, Downers Grove, Burr Ridge, Lombard, Oak Park — bring country clubs and private estates like The Drake Oak Brook, Morton Arboretum in Lisle and Cantigny Park in Wheaton, usually with longer events and a wider age range in the room. And the reach runs well past Chicagoland — Heritage Harbor in Ottawa, Pear Tree Estate in Champaign, Allerton Park in Monticello — which is exactly why the 100-mile radius is worth spelling out." },
        ],
        closing: [
          "And Chicago weddings are rarely monocultural — this city's families blend traditions constantly, and a single reception might need several musical worlds to sit comfortably side by side. I welcome and respect all cultures, religions, identities and orientations, and I prepare for those evenings the way I'd prepare for any other: by learning your family's music and the running order before I ever touch a fader.",
        ],
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which areas of Chicagoland do you cover?", answer: "Chicago proper plus Naperville, Oak Brook, Glenview, Hinsdale, Downers Grove, Burr Ridge, Lombard, Oak Park and the surrounding suburbs. Anywhere within 100 miles of Chicago carries no travel surcharge; destinations further out are available with a travel fee, quoted upfront." },
          ...
          { category: "Booking", question: "How far in advance should I book?", answer: "It depends on the event: weddings run 6 to 24 months in Chicago, corporate events are typically 2 to 4 months (early December much further), and private events 1 to 6 months. I'm already booking into 2028, so enquire early — everything else is more flexible." },
  ...
  // Creek Mountain Camp also appear in the testimonials, Black Canyon Inn in her
  // VibeReel, and The Broadmoor and Estes Park Resort in the gallery photos; the
  // rest — Skylight, Moss, Ironworks, Cielo at Castle Pines, Bonnie Blues, Della
  // Terra, The Landing, The Stanley Hotel, Spruce Mountain Ranch — are from her
  // venue list.
  denver: {
    wedding: {
      hero: {
      ...
      localMarket: {
        ...
        blocks: [
          { label: "Denver proper", text: "— RiNo, LoDo, the Union Station district — is where the city's industrial venues live: converted warehouses and brick-and-steel rooms like Skylight, Moss and Ironworks, alongside polished spaces like the Ritz-Carlton Denver, the Front Range behind them. City logistics, city timelines, and rooms that photograph beautifully but need careful sound placement. These weddings usually run a single evening with local guests and a familiar rhythm." },
          { label: "The foothills and the plains", text: "ring the city — The Manor House and Arrowhead Golf Club in Littleton, Cielo at Castle Pines to the south, Bonnie Blues out in Elizabeth to the east. A short drive from downtown, but already rural in feel: the bridge between a city wedding and a mountain one, and often the sweet spot for couples who want the view without the two-hour drive." },
          { label: "The mountains", text: "are another world — Vail, Breckenridge, the canyons out toward Bailey, at venues like Deer Creek Mountain Camp in Bailey and Evergreen Lake House, where the view is the whole point and the infrastructure is an afterthought. Power can be limited. Cell signal disappears. The drive from Denver runs one to two hours, and in winter it runs longer. I arrive with time built in rather than hoping the pass is clear, and I plan the setup around what the venue can actually supply. And I work well past the metro — The Broadmoor down in Colorado Springs, Spruce Mountain Ranch in Larkspur — which is exactly why the 100-mile radius is worth spelling out." },
      ...
      faq: {
        ...
        items: [
          ...
          { category: "Equipment", question: "What's included when I book you?", answer: "A professional BOSE sound system, a Shure wireless handheld microphone and stand, and dance floor lighting come standard. Optional additions include a stationary photo booth, a 360 photo booth, a mobile photo booth trailer, an audio guestbook, CO2 cannons, a fog machine, glow sticks, and more on request." },
          { category: "Booking", question: "How far ahead should we book a summer mountain wedding?", answer: "Peak summer mountain Saturdays, June to September, go 6 to 24 months out, and the most sought-after venues go further. I'm already booking into 2028, so enquire early — winter and shoulder-season dates have real availability." },
          { category: "Booking", question: "What's the investment?", answer: "DJ Miss Haze thinks of it as an investment, not a price. Wedding investment begins at $3,500 during main season, with off-season pricing available — covering custom DJ and MC services, preparation meetings, vendor collaboration, custom song edits for key moments, and the full audio, microphone and dance-floor lighting setup." },
    ...
    hub: {
      ...
      localMarket: {
        ...
        blocks: [
          { label: "Denver proper", text: "— RiNo, LoDo, Union Station, the downtown core — is where the city's industrial venues sit: converted warehouses and brick-and-steel spaces like Skylight, Moss and Ironworks, alongside polished rooms like the Ritz-Carlton Denver, the Front Range behind them. City timelines, city logistics, rooms that look superb and need thoughtful sound placement." },
          { label: "The foothills and the plains", text: "ring the city — The Manor House and Arrowhead Golf Club in Littleton, Cielo at Castle Pines to the south, Bonnie Blues out in Elizabeth. A short drive from downtown but already rural in feel, and the natural middle ground between a city event and a mountain one." },
          { label: "The mountains", text: "— Vail, Breckenridge, the canyons toward Bailey — are where Colorado earns its reputation, at venues like Deer Creek Mountain Camp in Bailey and Evergreen Lake House. Estes Park has become a destination in its own right, with a run of venues I know well — The Stanley Hotel, Della Terra, the Estes Park Resort, Black Canyon Inn and The Landing. The view is the point and the infrastructure is secondary: limited power, unreliable signal, drive times of one to two hours that stretch further in winter. And the range runs further still — The Broadmoor in Colorado Springs, Spruce Mountain Ranch in Larkspur — which is why the 100-mile radius is worth spelling out." },
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which areas of Colorado do you cover?", answer: "Denver and the metro area, plus Estes Park, Vail, Breckenridge and the surrounding mountain communities, and south through Castle Pines and Larkspur to Colorado Springs. Anywhere within 100 miles of Denver carries no travel surcharge; anything further afield is available with a travel fee, quoted upfront." },
          ...
          { category: "Equipment", question: "What equipment comes with a booking?", answer: "A professional BOSE sound system, a Shure wireless handheld microphone and stand, and dance floor lighting as standard. Optional extras include a stationary photo booth, a 360 photo booth, a mobile photo booth trailer, an audio guestbook, CO2 cannons, a fog machine, glow sticks, and more on request." },
          { category: "Booking", question: "How far in advance should I book?", answer: "It depends: mountain weddings run 6 to 24 months, corporate events are typically 2 to 4 months (early December further), and private events 1 to 6 months. I'm already booking into 2028, so enquire early — winter and shoulder-season dates have far more availability." },
  ...
  dallas: {
    wedding: {
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which parts of the metroplex do you cover?", answer: "Dallas, Fort Worth, Plano, Frisco, McKinney and the surrounding areas. I've worked venues including NYLO Plano and 4 Eleven Fort Worth. Anywhere within 100 miles of Dallas–Fort Worth carries no travel surcharge; destinations beyond that are available with a travel fee, quoted upfront." },
    ...
    hub: {
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which areas do you cover?", answer: "Dallas, Fort Worth, Plano, Frisco, McKinney and the surrounding metroplex. Anywhere within 100 miles of Dallas–Fort Worth carries no travel surcharge; anything further out is available with a travel fee, quoted upfront." },
          { category: "DJ & MC Services", question: "Do you DJ and MC, or just DJ?", answer: "Both, as a single service. Announcements, introductions, timeline management and the microphone are included — no separate MC needed." },
          { category: "DJ & MC Services", question: "Can you run a bilingual reception?", answer: "For bilingual receptions I work with a bilingual MC on request — common across Dallas–Fort Worth and Chicago. I DJ and MC in English (I also speak German); the bilingual MC covers the Spanish announcements, and we plan the running order together in advance." },
          ...
          { category: "Equipment", question: "What equipment comes with a booking?", answer: "A professional BOSE sound system, a Shure wireless handheld microphone and stand, and dance floor lighting as standard. Optional extras include a stationary photo booth, a 360 photo booth, a mobile photo booth trailer, an audio guestbook, CO2 cannons, a fog machine, glow sticks, and more on request." },
          { category: "Logistics & Reliability", question: "Do you carry liability insurance?", answer: "Yes, with a Certificate of Insurance available on request." },
          { category: "Booking", question: "How far in advance should I book?", answer: "It depends on the event: Dallas–Fort Worth weddings run a shorter 2 to 8 months, corporate events are typically 2 to 4 months (early December further), and private events 1 to 6 months. I'm already booking into 2028, so enquire early — summer and winter are far more open." },
          { category: "Locations", question: "Are you local to Dallas–Fort Worth?", answer: "DJ Miss Haze is Chicago-based and travels to Dallas–Fort Worth mainly in winter, but she's available year-round and keeps a full set of equipment in the DFW market — so nothing has to travel in and setup is never a compromise." },
        ],
      },
      reviews: {
