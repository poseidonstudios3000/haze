...
//
// VENUES: named venues in Chicago and Denver copy below are client-confirmed.
  ...
  denver: {
    wedding: {
      ...
      localMarket: {
        ...
        blocks: [
          { label: "Denver proper", text: "— RiNo, LoDo, the Union Station district — brings converted warehouses, brick-and-steel event spaces and polished rooms like the Ritz-Carlton Denver, with the Front Range behind them. City logistics, city timelines, and rooms that photograph beautifully but need careful sound placement. These weddings usually run a single evening with local guests and a familiar rhythm." },
          { label: "The mountains", text: "are another world — Estes Park, Vail, Breckenridge, the canyons out toward Bailey, at venues like Deer Creek Mountain Camp in Bailey and Evergreen Lake House, where the view is the whole point and the infrastructure is an afterthought. The foothills sit in between: The Manor House and Arrowhead Golf Club in Littleton are a short drive from the city but already feel like the mountains. Power can be limited. Cell signal disappears. The drive from Denver runs one to two hours, and in winter it runs longer. I arrive with time built in rather than hoping the pass is clear, and I plan the setup around what the venue can actually supply." },
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Do you travel to mountain venues?", answer: "Yes — Estes Park, Vail, Breckenridge and the surrounding areas are standard territory. I've worked venues including Estes Park Resort, Black Canyon Inn and Deer Creek Mountain Camp. Anywhere within 100 miles of Denver carries no travel surcharge; destinations beyond that are available with a travel fee, quoted upfront." },
    ...
    hub: {
      ...
      localMarket: {
        ...
        blocks: [
          { label: "Denver proper", text: "— RiNo, LoDo, Union Station, the downtown core — brings converted warehouses, brick-and-steel event spaces and polished rooms like the Ritz-Carlton Denver, with the Front Range behind them. City timelines, city logistics, rooms that look superb and need thoughtful sound placement." },
          { label: "The mountains", text: "— Estes Park, Vail, Breckenridge, the canyons toward Bailey — are where Colorado earns its reputation, at venues like Deer Creek Mountain Camp in Bailey and Evergreen Lake House. The foothills sit in between — The Manor House and Arrowhead Golf Club in Littleton — a short drive out but already mountain in feel. The view is the point and the infrastructure is secondary: limited power, unreliable signal, and drive times of one to two hours from Denver that stretch further in winter. Every one of those is manageable with planning and a problem without it." },
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which areas of Colorado do you cover?", answer: "Denver and the metro area, plus Estes Park, Vail, Breckenridge and the surrounding mountain communities. Anywhere within 100 miles of Denver carries no travel surcharge; anything further afield is available with a travel fee, quoted upfront." },
