  ...
  chicago: {
    wedding: {
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Do you travel to the Chicago suburbs?", answer: "Yes. Elmhurst, Naperville, Oak Brook, Glenview, Hinsdale, Lombard, Schaumburg, Hoffman Estates, St. Charles, Geneva, Bolingbrook and the wider Chicagoland area are all standard territory — I've worked venues like The Drake Oak Brook, Morton Arboretum in Lisle, Cantigny Park in Wheaton and Riverside Receptions in Geneva, and further out to Heritage Harbor in Ottawa, Pear Tree Estate in Champaign and toward Edwards near Peoria. Anywhere within 100 miles of Chicago carries no travel surcharge; destinations beyond that are available with a travel fee, quoted upfront." },
    ...
    corporate: {
      ...
      faq: {
        ...
        items: [
          ...
          { category: "Locations", question: "Do you travel to the suburbs for company events?", answer: "Yes — Oak Brook, Naperville, Elmhurst, Lombard, Glenview, Hinsdale, Schaumburg, Hoffman Estates, St. Charles, Geneva, Bolingbrook and the wider Chicagoland area. Anywhere within 100 miles of Chicago carries no travel surcharge; beyond that is available with a travel fee, quoted upfront." },
    ...
    hub: {
      ...
      localMarket: {
        ...
        blocks: [
          ...
          { label: "The suburbs", text: "— Naperville, Oak Brook, Glenview, Hinsdale, Elmhurst, Lombard, Schaumburg, Hoffman Estates, St. Charles, Geneva, Bolingbrook — are where a lot of Chicago events actually land: a large guest count in an intimate, tucked-away setting. Country clubs and private estates like The Drake Oak Brook, Morton Arboretum in Lisle and Cantigny Park in Wheaton, usually with longer events and a wider age range in the room. And the reach runs well past Chicagoland — Heritage Harbor in Ottawa, Pear Tree Estate in Champaign, out toward Edwards near Peoria — which is exactly why the 100-mile radius is worth spelling out." },
        ],
        closing: [
          "And Chicago weddings are rarely monocultural — this city's families blend traditions constantly, and a single reception might need several musical worlds to sit comfortably side by side. I welcome and respect all cultures, religions, identities and orientations, and I prepare for those evenings the way I'd prepare for any other: by learning your family's music and the running order before I ever touch a fader.",
        ],
      ...
      faq: {
        title: "FREQUENTLY ASKED",
        items: [
          { category: "Locations", question: "Which areas of Chicagoland do you cover?", answer: "Chicago proper plus Elmhurst, Naperville, Oak Brook, Glenview, Hinsdale, Lombard, Schaumburg, Hoffman Estates, St. Charles, Geneva, Bolingbrook and the surrounding suburbs. Anywhere within 100 miles of Chicago carries no travel surcharge; destinations further out are available with a travel fee, quoted upfront." },
    ...
    wedding: {
      ...
      localMarket: {
        ...
        closing: [
          ...
          "I don't work the metroplex in isolation, either. Over the years I've built a circle of trusted Dallas–Fort Worth vendors — photographers, designers, content creators and more — and I'm glad to collaborate with yours or point you toward people I've worked alongside and rate, if you're still filling out your team.",
        ],
      },
      logistics: {
