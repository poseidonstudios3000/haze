...
const FAQ_PAGE_CONTENT: FAQContent = {
  ...
  items: [
    ...
    { category: "Equipment & Production", question: "What optional extras are available?", answer: "A 360 photo booth, dancing on the clouds, smoke and fog effects, CO2 cannons, glow sticks and yard games. Popular additions for brand activations and larger celebrations." },
    ...
    // 4. Travel & Locations
    { category: "Travel & Locations", question: "Which areas do you cover?", answer: "Chicago and Chicagoland — including Naperville, Oak Brook, Glenview, Hinsdale, Downers Grove, Burr Ridge, Lombard and Oak Park. Dallas–Fort Worth, including Plano, Frisco and McKinney. Denver and the Colorado mountains, including Vail, Estes Park and Breckenridge." },
    { category: "Travel & Locations", question: "Do you travel outside those areas?", answer: "Yes — destination events are welcome. Travel beyond the standard service area is quoted transparently upfront, with no surprises later." },
    { category: "Travel & Locations", question: "Is there a travel charge for suburbs?", answer: "Within each metro area's standard service range, no. Anything further is quoted clearly before you book." },
