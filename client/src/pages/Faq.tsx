...
const FAQ_PAGE_CONTENT: FAQContent = {
  ...
  items: [
    ...
    { category: "Booking & Availability", question: "How far in advance should I book?", answer: "It depends on the event and the market. Weddings run 6 to 24 months in Chicago and Denver, but a shorter 2 to 8 months in Dallas–Fort Worth. Corporate events are typically 2 to 4 months (the first two weeks of December much further out), and private events 1 to 6 months. I'm already booking into 2028, so inquire early — off-peak dates and weekdays have far more availability, and if your date is close, ask anyway." },
    { category: "Booking & Availability", question: "How do I check if my date is available?", answer: "Send an inquiry with your date, location and event type. I'll come back with availability and a quote. If your date is taken I'll tell you straight away rather than leaving you waiting." },
